...
export function useRecommendations({
  ...
  const energyRecommendations = (): Recommendation[] => {
  ...
  const stimulationRecommendations = (): Recommendation[] => {
    const recommendations = []
  ...
  const routineRecommendations = (): Recommendation[] => {
    const recommendations = []
  ...
  return {
    ...
    stimulationRecommendations: stimulationRecommendations(),
