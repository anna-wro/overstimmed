...
/** @fileoverview Range slider component built on Radix UI. */
    ...
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-secondary dark:bg-secondary/70">
      <div
        className={cn(
          ...
          dataType === "energy"
            ? "bg-linear-to-r from-blush-400 via-sand-300 to-mint-400 dark:from-blush-500 dark:via-sand-500 dark:to-mint-500 high-contrast:from-blush-700 high-contrast:via-sand-700 high-contrast:to-mint-700 dark:high-contrast:from-blush-600 dark:high-contrast:via-sand-600 dark:high-contrast:to-mint-600"
