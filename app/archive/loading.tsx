  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-sand-50 to-lavender-50 dark:from-lavender-950 dark:to-sand-950">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-lg font-medium text-lavender-700 dark:text-lavender-300">Loading archive...</p>
        <p className="text-sm text-muted-foreground">Retrieving your past entries</p>
      </div>
    </div>
  )
}
